...
- **Ecowitt station:** Cloud API ingest is live; **Vercel Hobby cannot run minute crons** — use an external scheduler for `/api/cron/ecowitt-sync`. See [docs/ecowitt.md](docs/ecowitt.md).
